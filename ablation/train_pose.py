...
def training(dataset, opt, pipe, dataset_name, debug_from, logger=None):
    ...
    while start_view_id < num_views:
        ...
        for iteration in range(first_iter, opt.iterations + 1):
            ...
            # Pose gradient scaling
            apply_inlier_weighted_pose_grad(viewpoint_cam, phase="local", p_mu=0.1)
        ...
        for iteration in range(first_iter, opt.iterations + 1):
            ...
            # Pose gradient scaling
            apply_inlier_weighted_pose_grad(viewpoint_cam, phase="global", p_mu=0.1)
