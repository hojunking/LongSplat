...
HIKE_COMP_DATA_ROOT="/workdir/data/compress-o/hike/qp37_half"
OUTPUT_ROOT="outputs/hike/compressed_baseline"
...
for scene in "${SCENES_HIKE[@]}"; do
    ...
    echo "   - COMP DATA : ${HIKE_COMP_DATA_ROOT}/${scene}"
    echo "   - ORIG DATA : ${HIKE_DATA_ROOT}/${scene}"
    echo "   - MODEL     : ${MODEL_PATH}"

    # 1️⃣ Training
    python train.py --eval \
        -s ${HIKE_COMP_DATA_ROOT}/${scene} \
        -m ${MODEL_PATH} \
        -r 4 \
        --port ${port} \
        --mode hike
