...
DEFAULT_IMAGE_DIR = Path(
    "/home/knuvi/Desktop/song/LongSplat/data/compress-o/free/qp27/lab/images"
)
DEFAULT_OUTPUT = Path(
    "/home/knuvi/Desktop/song/LongSplat/video_outputs/lab_input_qp27.mp4"
)
...
def build_video(image_paths, output_path: Path, fps: float, crf: int, preset: str):
    if not image_paths:
...
def main():
    ...
    build_video(ordered_images, args.output, args.fps, args.crf, args.preset)
