...
SCENES=("lab")
#SCENES=("pillar" "road" "sky" "stair")


QP_LEVELS=("qp37")
COMPRESSED_DATA="/workdir/data/compress-o/free/codiff"
ORIGINAL_DATA="/workdir/data/compress-x/free"
OUTPUT_BASE="outputs/free_qp37_codiff05_baseline"
SHEET_NAME="rebuttal"
...
for SCENE in "${SCENES[@]}"; do
  for QP in "${QP_LEVELS[@]}"; do
    SCENE_QP="${SCENE}_${QP}_codiff05_baseline"
